...
Promptor now opens with a concise two-section editorial landing page before the workspace. The hero offers separate **Start a story** and **Plan a product** paths alongside one large storyboard-board visual. The second section uses a numbered creative process, a real storyboard-board proof image, creator categories, a concise FAQ, and a final workspace call to action. Landing imagery is delivered as optimized WebP assets and scroll-reveal motion respects reduced-motion preferences.
